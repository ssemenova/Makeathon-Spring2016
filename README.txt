	...
	-----------------------------------------------------------------------------
		TO VIEW LOCALLY ON MAC

		1. Unzip the file on your Desktop
		2. Open Terminal
		3. Type 'cd Desktop/makeathon' without the quotes
		4. type 'python -m SimpleHTTPServer' without the quotes
		5. Open a web browser and type in the Address Bar 'localhost:8000'
		and press enter
